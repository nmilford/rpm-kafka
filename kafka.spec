...
install    -m 644 %{_builddir}/%{kafka_name}-%{kafka_version}-incubating-src/core/target/scala_2.8.0/%{kafka_name}-%{kafka_version}.jar %{buildroot}/%{kafka_home}/core/target/scala_2.8.0/
...
%changelog
* Sat Jun 29 2013 Nathan Milford <nathan@milford.io> [0.7.2-1]
- Bumped to Kafka 0.7.2.
